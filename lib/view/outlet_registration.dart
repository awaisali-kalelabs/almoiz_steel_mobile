...
class RegistrationFormScreen extends StatelessWidget {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                CustomFormField(controller: controller.businessNameController,validator: (value) {
                ...
                CustomFormField(controller: controller.ownerNameController,validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'This field is required';
                  }
                  return null;
                ...
                CustomFormField(controller: controller.billingAddressController,validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'This field is required';
                  }
                  return null;
                ...
                CustomFormField(controller: controller.shippingAddressController,validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'This field is required';
                  }
                  return null;
                ...
                CustomFormField(
                  controller: controller.logisticsContactPersonController,validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'This field is required';
                  }
                  return null;
                ...
                CustomFormField(controller: controller.cityNameController,validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'This field is required';
                  }
                  return null;
                ...
                CustomFormField(controller: controller.completeAddressController,validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'This field is required';
                  }
                  return null;
                ...
                CustomCheckbox(
                  title: 'Owner',
                  value: controller.isOwner, // This should be an RxBool from the controller
                  onChanged: () {
                ...
                CustomCheckbox(
                  title: 'Rent',
                  value: controller.isOnRent, // This should be an RxBool from the controller
                  onChanged: () {
                ...
                CustomButtonWidget(
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      Get.to(() => OutletRegistrationImages(), transition: Transition.leftToRight);
                    }
                    },
                ),
              ],
  ...
  // Helper function to build text fields with custom style
  ...
  // Helper function to build title text
  ...
  // Helper function to build checkbox with custom style
  // Widget _buildCheckbox(String title, RxBool value, VoidCallback onChanged) {
  //   return Row(
