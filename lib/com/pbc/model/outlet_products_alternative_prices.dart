...
class OutletProductsAlternativePrices {
  ...
  factory OutletProductsAlternativePrices.fromJson(Map<String, dynamic> json) {
    return OutletProductsAlternativePrices(
        product_id: int.parse(json['ProductID']),
        package_id: int.parse(json['PackageID']),
        package_label: (json['PackageLabel']),
        brand_id: int.parse(json['BrandID']),
        brand_label: json['BrandLabel'],
        raw_case_price: double.parse(json['RawCasePrice']),
        unit_price: double.parse(json['UnitPrice']),
        liquid_in_ml: double.parse(json['LiquidInML']));
  }
  @override
  String toString() {
