...
class _OrdersReportView extends State<OrdersReportView> {
  ...
  void getOrdersPosition() async {
    ...
    try{
      var url = Uri.https(globals.ServerURL, '/portal/mobile/MobileOrdersReport', QueryParameters);
//      var url = Uri.http("192.168.30.125:8080", '/nisa_portal/mobile/MobileOrdersReport', QueryParameters);
