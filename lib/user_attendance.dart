...
import 'user_attendance_action.dart';
import 'globals.dart' as globals;

// This app is a stateful, it tracks the user's current choice.
class UserAttendance extends StatefulWidget {
  @override
  _UserAttendance createState() => _UserAttendance();
}

class _UserAttendance extends State<UserAttendance> {
                    ...
                    children: <Widget>[
                      Column(
                        children: [
                          Container(
                            child: Text(
                              "Please select user attendance type",
                              style: TextStyle(
                                  fontSize: 16,
