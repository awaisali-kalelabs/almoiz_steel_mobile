...
import 'attendance_action_old.dart';
...
class OutletOrderImage extends StatefulWidget {
  int outletId;
  OutletOrderImage({this.outletId});
  @override
  _OutletOrderImage createState() => _OutletOrderImage();
}

class _OutletOrderImage extends State<OutletOrderImage> {
  int OrderID = 0;
  @override
  void initState() {
    super.initState();
    OrderID = getOrderNumber(widget.outletId);
  }
