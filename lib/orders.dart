                                  ...
                                  visible: isQuantityNotAdded,
                                    child:
                                      Container(
                                        ...
                                        child: Text("ABC",textAlign: TextAlign.left,style: TextStyle(color: Colors.green),),
                                      ),
                                ),*/
                                  Container(
                                    // width: cardWidth,
        ...
        Container(
          child: ListTile(
            onTap: () async {
              ...
              globals.brand_id = Products[index]['lrb_type_id'];
            ...
            title: Text(Products[index]['product_label'].toString(),
                    ...
                    onPressed: () {
                      if (globals.isMultipleProductsFree == 0) {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => PromotionSkuSelection()),
                        );
                      }
                    }),
              ),
